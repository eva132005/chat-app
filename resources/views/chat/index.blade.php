    ...
    <div class="w-72 bg-white border-r border-gray-200 flex flex-col">
        <div class="p-4 border-b border-gray-200">
            ...
            <form action="/logout" method="POST" class="mt-1">
                @csrf
                <button type="submit" class="text-xs text-red-400 hover:text-red-600">Logout</button>
            </form>
        </div>
        ...
        <div class="p-4 flex-1 overflow-y-auto">
            ...
            <form action="{{ route('chat.private') }}" method="POST">
                ...
                <button type="submit" class="w-full flex items-center gap-3 p-2 rounded hover:bg-gray-100 mb-1">
                    <span class="w-2 h-2 rounded-full {{ $user->is_online ? 'bg-green-400' : 'bg-gray-300' }}"></span>
            ...
            <a href="{{ route('chat.room', $room) }}"
               class="flex items-center gap-3 p-2 rounded hover:bg-gray-100 mb-1">
